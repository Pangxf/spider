...
class Bilibili_Spider():
    ...
    def get_videos_by_page(self, idx):
        # 获取第 page_idx 页的视频信息
        urls_page, titles_page, plays_page, dates_page, durations_page, covers_page = [], [], [], [], [], []
        ...
        for li in ul_data.find_all('li'):
            ...
            covers_page.append(cover_page)

        return urls_page, titles_page, plays_page, dates_page, durations_page, covers_page

    def save(self, json_path, bvs, urls, titles, plays, durations, dates,covers):
        data_list = []
    ...
    def get(self):
        ...
        for idx in range(self.page_num):
            ...
            urls_page, titles_page, plays_page, dates_page, durations_page,covers_page = self.get_videos_by_page(idx)
            ...
            if self.save_by_page:
                ...
                self.save(json_path_page, bvs_page, urls_page, titles_page, plays_page, durations_page, dates_page,covers_page)

        json_path = osp.join(self.save_dir_json, '{}_{}'.format(self.user_name, self.uid), 'primary', 'full.json')
        self.save(json_path, bvs, urls, titles, plays, durations, dates,covers)
